            ...
            <div class="result-player-box">
                ...
                ${dunCards.map(dun => `
                    <div class="dun-row">
                        ...
                        <div class="dun-cards">
                           ${dun.map(c => `<img src="assets/cards/${c.id}" class="card">`).join('')}
                        </div>
                    </div>
                `).join('')}
            </div>
